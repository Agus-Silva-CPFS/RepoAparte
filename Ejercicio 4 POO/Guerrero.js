...
var Guerrero = /** @class */ (function (_super) {
    ...
    function Guerrero(nombre, vida, danio, energia, testo) {
        var _this = _super.call(this, nombre, vida, danio, energia) || this;
        _this.testo = Math.random() * (5500 - 15) + 15;
        return _this;
    }
    Guerrero.prototype.atacar = function (enemigo) {
        var calcularDanio = _super.prototype.setDanio.call(this) + this.testo;
